...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull TextInputLayout email, @NonNull Guideline guilelineMediumHorizontal,
      @NonNull ImageView imgLogin, @NonNull TextInputLayout password, @NonNull TextView textView2) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, email,
          guilelineMediumHorizontal, imgLogin, password, textView2);
    }
